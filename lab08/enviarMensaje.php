...
$mascota = $sentencia->fetch(PDO::FETCH_OBJ);
    ...
    $data = [
        ...
        "message" =>  'HOLA, hoy por ser nuestro leal cliente, tu mejor amigo  *'.strtoupper($mascota->nombre).'* te brinda la oportunidad de no perderte el *'.strtoupper($mascota->promocion).'* valido solo *'.$mascota->duracion.'* No te pierdas esta oportunidad y animate a engreir a tu buen amigo fiel!! 🐶 '
    ];
    $options = array(
        'http' => array(
            'method'  => 'POST',
